...
class Level:
    ...
    def create_map(self):
        ...
        layouts = {
            'boundry': import_csv_layout('./src/map/map_FloorBlocks.csv'),
        ...
        graphics = {
            'grass': import_folder('./src/grass'),
            'objects': import_folder('./src/objects'),
            ...
            for row_index, row in enumerate(layout):
                for col_index, col in enumerate(row):
                    if col != '-1':
                        ...
                        if style == 'entities':
                            if col == '394' :
                                self.player =self.player = Player((x,y),
        ...
        #BASIC MAP GENERATE BASE ON ARRAYS
...
class YSortCameraGroup(pygame.sprite.Group):   
    def __init__(self):
        ...
        #creating the floor
        self.floor_surf = pygame.image.load('./src/tilemap/ground.png').convert()
